...
<body>
    ...
    <div class="container"> <!-- Container utama Bootstrap. -->
        ...
        <div class="card mt-3"> <!-- Margin top untuk jarak bagian atas. -->
            <div class="card-header bg-primary text-white"> <!-- Header card dengan background biru. -->
                Data Anggota
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="tidanggota"
                                                    value="<?= $data['ID_Anggota'] ?>" placeholder="Masukkan id Anggota!">
